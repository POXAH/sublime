...
<table class="tg">
    ...
    <tr>
        <td class="tg-1imq">Sum</td>
        <td class="tg-38if"><?=$post['sum']?></td>
    </tr>
    <tr>
        <td class="tg-1imq">Date</td>
        <td class="tg-38if"><?=$post['date']?></td>
    </tr>
    <tr>
        <td class="tg-1imq">Payment Method</td>
        <td class="tg-38if"><?=$arrDelivery[$post['delivery_method']]?></td>
    </tr>
</table>
